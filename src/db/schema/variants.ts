...
// 把 productVariantValues 和它的 relations 提前（在 productVariantsRelations 之前）
export const productVariantValues = mysqlTable(
...
export const productVariantsRelations = relations(
  ...
  ({ one, many }) => ({
    ...
    // 现在 productVariantValues 已经定义，引用不会是 undefined
